...
class KITTIDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            # crop_w = random.randint(512, 850)
            # crop_h = random.randint(256, 350)
            # n = crop_w // 32
            # crop_w = n * 32
            # n = crop_h // 32
            # crop_h = n * 32
            ...
            #         "left_disp": disp_occ,
            #         "occ_mask": occ_mask}
            return left_img, right_img, disp_occ, occ_mask
        else:
            w, h = left_img.size
            ...
            if self.disp_occ_filenames is not None:
                return left_img, right_img, disp_occ, disp_occ
                # return {"left": left_img,
                #         "right": right_img,
                #         "left_disp": disp_occ,
                #         "top_pad": top_pad,
